...
//Customizable
#define MAXMESH 500
#define NUMBERMESH 500
#define NUMBERTEXTURES 500
...
GLfloat uDifColour[NUMBERCOLOURS][4];
	...
	/* initialized to 0, set to 1 when colour stored in u*Colour[][] */
...
//ADDED FOR OPENGL
void draw2Dcircle(float cx, float cy, float r, int num_segments);
